...
METADADOS_TABELAS: dict[str, dict[str, Any]] = {
    ...
    "dim_partido": {
        ...
        "exige_chave": False,
        "instrucao_auth": "Relação oficial de partidos com registro no TSE.",
        "granularidade": "1 partido político (sigla)",
        "completude_default": "total",
        "linhas_origem_default": 30,
    },
    "dim_metrica": {
    ...
    "dim_de_para_ente": {
        ...
        "exige_chave": False,
        "instrucao_auth": "Ponte cadastral calculada por cruzamento determinístico.",
        "granularidade": "1 de-para ente (fonte_origem, id_origem)",
        "completude_default": "total",
        "linhas_origem_default": 5570,
    },
    "dim_magistrado": {
    ...
    "dim_subsidio": {
        ...
        "exige_chave": False,
        "instrucao_auth": "Valores transcritos de normas federais e estaduais com citação legal.",
    ...
    "despesa_parlamentar": {
        ...
        "url_origem": "https://dadosabertos.camara.leg.br/swagger/api.html",
        "url_template": "https://dadosabertos.camara.leg.br/arquivos/ano/csv/Ano-{ano}.csv.zip",
        "exige_chave": False,
    ...
    "presenca_evento": {
        ...
        "url_origem": "https://dadosabertos.camara.leg.br/swagger/api.html",
        "url_template": "https://dadosabertos.camara.leg.br/arquivos/eventosPresencasDeputados/csv/eventosPresencasDeputados-{ano}.csv",
        "exige_chave": False,
        "instrucao_auth": "API pública aberta da Câmara dos Deputados (sem chave).",
    ...
    "transferencia_uniao": {
        ...
        "url_origem": "https://apidatalake.tesouro.gov.br/docs/siconfi/",
        "url_template": "https://apidatalake.tesouro.gov.br/ords/aria/tt/transf_constitucionais?an_exercicio={ano}",
        "exige_chave": False,
        "instrucao_auth": "API pública aberta do SIAFI / Tesouro Nacional (sem chave).",
    ...
    "custo_orgao": {
        ...
        "url_origem": "https://apidatalake.tesouro.gov.br/docs/siconfi/",
        "url_template": "https://apidatalake.tesouro.gov.br/ords/aria/tt/custo_orgao_federal?an_exercicio={ano}",
        "exige_chave": False,
        "instrucao_auth": "API pública aberta do Tesouro Nacional (sem chave).",
